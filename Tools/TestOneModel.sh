...
-ChapterOutlineModel datacrystals/miqulitz120b-v2:latest \
-ChapterS1Model datacrystals/miqulitz120b-v2:latest \
-ChapterS2Model datacrystals/miqulitz120b-v2:latest \
-ChapterS3Model datacrystals/miqulitz120b-v2:latest \
-ChapterS4Model datacrystals/miqulitz120b-v2:latest \
